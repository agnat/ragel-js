...
void JSTabCodeGen::GOTO( ostream &out, int gotoDest, bool inFinish )
{
	out << 
		"	{\n"
		"		" << vCS() << " = " << gotoDest << ";\n"
...
void JSTabCodeGen::GOTO_EXPR( ostream &out, GenInlineItem *ilItem, bool inFinish )
{
	out << 
		"	{\n"
		"		" << vCS() << " = (";
...
void JSTabCodeGen::CALL( ostream &out, int callDest, int targState, bool inFinish )
{
	if ( prePushExpr != 0 ) {
		out << "{\n";
...
void JSTabCodeGen::CALL_EXPR(ostream &out, GenInlineItem *ilItem, int targState, bool inFinish )
{
	if ( prePushExpr != 0 ) {
		out << "{\n";
		INLINE_LIST( out, prePushExpr, 0, false );
...
void JSTabCodeGen::RET( ostream &out, bool inFinish )
{
	out <<
		"	{\n"
		"		" << TOP() << " -= 1;\n"
...
void JSTabCodeGen::BREAK( ostream &out, int targState )
{
	out << 
		"	{\n"
		"		" << P() << " += 1;\n"
